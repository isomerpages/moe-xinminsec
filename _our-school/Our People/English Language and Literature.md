  ...
  <tbody style="margin: 0px; outline: 0px; padding: 0px">
    ...
    <tr style="margin: 0px; outline: 0px; padding: 0px">
      ...
      <td style="margin: 0px;
          ...
          padding: 0px 15px 15px 0px;
          vertical-align: top;">
        <img src="/images/English Language/Ee_Ai_Lin.png" alt="Pang Hui Chin web.jpg" class="ive_eobj_left" style="margin: 0px 10px 0px 0px;
            outline: 0px;
            padding: 0px;
            border: none;
            max-width: 100%;
      ...
      <td style="margin: 0px;
        ...
        <div style="margin: 0px;
            ...
            font-size: 17px;
            font-weight: 400;">
          <b style="margin: 0px; outline: 0px; padding: 0px">Ms Ee Ai Lin</b>
        </div>
        <div style="margin: 0px;
            outline: 0px;
            padding: 0px;
      ...
      <td style="margin: 0px;
        ...
        <div style="margin: 0px;
            ...
            font-size: 17px;
            font-weight: 400;">
          <b style="margin: 0px; outline: 0px; padding: 0px">Ms Keveri D/O Rajoo</b>
        </div>
        <div style="margin: 0px;
            outline: 0px;
            padding: 0px;
    ...
    <td style="margin: 0px;
      ...
      <td style="margin: 0px;
        ...
        <div style="margin: 0px;
            ...
            font-size: 17px;
            font-weight: 400;">
          <b style="margin: 0px; outline: 0px; padding: 0px">Ms Teoh Yu Han </b>
        </div>
        <div style="margin: 0px;
            outline: 0px;
            padding: 0px;
        ...
        <div style="margin: 0px;
            ...
            font-size: 17px;
            font-weight: 400;">
          Email:<span>&nbsp;</span><a href="mailto:teoh_yu_han@schools.gov.sg" target="" style="margin: 0px;
              outline: 0px;
              padding: 0px;
              color: rgb(42, 103, 183);
              text-decoration: underline;">teoh_yu_han@schools.gov.sg
</a>
        </div>
      </td>
		</tr>
    <tr style="margin: 0px; outline: 0px; padding: 0px">
     ...
     <img style="margin: 0px 10px 0px 0px;
            ...
            float: left;
            width: 113px;
            height: 143px;" class="ive_eobj_left" alt="ho xin yi angeline.jpg" src="/images/sl_a_lady.png"><br style="margin: 0px; outline: 0px; padding: 0px">
      </td>
      <td style="margin: 0px;
          outline: 0px;
          padding: 0px 15px 15px 0px;
