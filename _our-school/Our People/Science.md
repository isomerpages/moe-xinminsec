    ...
    <tr style="margin: 0px; outline: 0px; padding: 0px">
      <td style="margin: 0px;
        ...
        <img style="margin: 0px 10px 0px 0px;
            ...
            float: left;
            width: 108px;
            height: 148px;" class="ive_eobj_left" alt="Lim Boon Ping.jpg" src="/images/Science/estella.png"><br style="margin: 0px; outline: 0px; padding: 0px">
      </td>
      <td style="margin: 0px;
          outline: 0px;
          padding: 0px 15px 15px 0px;
      ...
      <td style="margin: 0px;
        ...
        <img style="margin: 0px 10px 0px 0px;
            ...
            float: left;
            width: 114px;
            height: 133px;" class="ive_eobj_left" alt="Lyn Song MeiEn.jpg" src="/images/Science/una.png"><br style="margin: 0px; outline: 0px; padding: 0px">
      </td>
      <td style="margin: 0px;
          outline: 0px;
          padding: 0px 15px 15px 0px;
