      ...
      <tr style="margin: 0px; outline: 0px; padding: 0px">
        ...
        <td style="margin: 0px;
          ...
          <div style="margin: 0px;
              ...
              font-size: 17px;
              font-weight: 400;">
            Department: Business and Infocomm and Mathematics
          </div>
          <div style="margin: 0px;
              outline: 0px;
              padding: 0px;
      ...
      <tr style="margin: 0px; outline: 0px; padding: 0px">
        ...
        <td style="margin: 0px;
          ...
          <div style="margin: 0px;
              ...
              font-size: 17px;
              font-weight: 400;">
            <b style="margin: 0px; outline: 0px; padding: 0px">Mr Muhammad Khir Bin Zulkifli</b>
          </div>
          <div style="margin: 0px;
              outline: 0px;
              padding: 0px;
          ...
          <div style="margin: 0px;
            ...
            Email:<span>&nbsp;</span><a style="margin: 0px;
                ...
                padding: 0px;
                color: rgb(42, 103, 183);
                text-decoration: underline;" target="" href="mailto:Muhammad_Khir_Zulkifli@schools.gov.sg">muhammad_khir_zulkifli@schools.gov.sg</a>
          </div>
        </td>
      </tr>
      <tr style="margin: 0px; outline: 0px; padding: 0px">
