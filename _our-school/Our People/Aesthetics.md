    ...
    <tr style="margin: 0px; outline: 0px; padding: 0px">
      <td style="margin: 0px;
        ...
        <img style="margin: 0px 10px 0px 0px;
            ...
            float: left;
            width: 114px;
            height: 131px;" class="ive_eobj_left" alt="Aminah Binte Mohd Nagieb.jpg" src="/images/Arts_Education/Aminah Binte Mohd Nagieb.jpg"><br style="margin: 0px; outline: 0px; padding: 0px">
      </td>
      <td style="margin: 0px;
          outline: 0px;
          padding: 0px 15px 15px 0px;
        ...
        <div style="margin: 0px;
            ...
            font-size: 17px;
            font-weight: 400;">
          <b style="margin: 0px; outline: 0px; padding: 0px">Ms Aminah Binte Mohd Nagieb</b>
        </div>
        <div style="margin: 0px;
            outline: 0px;
            padding: 0px;
        ...
        <div style="margin: 0px;
          ...
          Email:<span>&nbsp;</span><a style="margin: 0px;
              ...
              padding: 0px;
              color: rgb(42, 103, 183);
              text-decoration: underline;" target="" href="mailto:aminah_mohd_nagieb@schools.gov.sg">aminah_mohd_nagieb@schools.gov.sg</a>
        </div>
      </td>
    </tr>
    <tr style="margin: 0px; outline: 0px; padding: 0px">
    ...
    <tr style="margin: 0px; outline: 0px; padding: 0px">
      <td style="margin: 0px;
        ...
        <img style="margin: 0px 10px 0px 0px;
            ...
            float: left;
            width: 113px;
            height: 147px;" class="ive_eobj_left" alt="lio dan wei.jpg" src="/images/Arts_Education/lio%20dan%20wei.jpeg"><br style="margin: 0px; outline: 0px; padding: 0px">
      </td>
      <td style="margin: 0px;
          outline: 0px;
          padding: 0px 15px 15px 0px;
        ...
        <div style="margin: 0px;
            ...
            font-size: 17px;
            font-weight: 400;">
          <b style="margin: 0px; outline: 0px; padding: 0px">Ms Lio Dan Wei</b>
        </div>
        <div style="margin: 0px;
            outline: 0px;
            padding: 0px;
        ...
        <div style="margin: 0px;
          ...
          Email:<span>&nbsp;</span><a style="margin: 0px;
              ...
              padding: 0px;
              color: rgb(42, 103, 183);
              text-decoration: underline;" target="" href="mailto:lio_dan_wei@schools.gov.sg">lio_dan_wei@schools.gov.sg</a>
        </div>
      </td>
    </tr>
    <tr style="margin: 0px; outline: 0px; padding: 0px">
      <td style="margin: 0px;
        ...
        <img style="margin: 0px 10px 0px 0px;
            ...
            float: left;
            width: 114px;
            height: 139px;" class="ive_eobj_left" alt="Lionel_Foon 1.jpg" src="/images/Arts_Education/Lionel_Foon%201.jpg"><br style="margin: 0px; outline: 0px; padding: 0px">
      </td>
      <td style="margin: 0px;
          outline: 0px;
          padding: 0px 15px 15px 0px;
