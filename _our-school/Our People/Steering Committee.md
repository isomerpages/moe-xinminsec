    ...
    <tr style="margin: 0px; outline: 0px; padding: 0px">
      ...
      <td style="margin: 0px;
        ...
        <div style="margin: 0px;
            ...
            font-size: 17px;
            font-weight: 400;">
          <b style="margin: 0px; outline: 0px; padding: 0px">Mr Tan Soon Hui</b>
        </div>
        <div style="margin: 0px;
            outline: 0px;
            padding: 0px;
      ...
      <td style="margin: 0px;
        ...
        <img style="margin: 0px 10px 0px 0px;
            ...
            float: left;
            width: 137px;
            height: 161px;" class="ive_eobj_left" alt="Wu Danping.jpg" src="/images/School_Leaders/Goh_Kar_Whee.jpg"><br style="margin: 0px; outline: 0px; padding: 0px">
      </td>
      <td style="margin: 0px;
          outline: 0px;
          padding: 0px 15px 15px 0px;
        ...
        <div style="margin: 0px;
            ...
            font-size: 17px;
            font-weight: 400;">
          <b style="margin: 0px; outline: 0px; padding: 0px">Mr Goh Kar Whee</b>
        </div>
        <div style="margin: 0px;
            outline: 0px;
            padding: 0px;
      ...
      <td style="margin: 0px;
        ...
        <img style="margin: 0px 10px 0px 0px;
            ...
            float: left;
            width: 106px;
            height: 159px;" class="ive_eobj_left" alt="Wu Danping.jpg" src="/images/School_Leaders/Komathi.png"><br style="margin: 0px; outline: 0px; padding: 0px">
      </td>
      <td style="margin: 0px;
          outline: 0px;
          padding: 0px 15px 15px 0px;
        ...
        <div style="margin: 0px;
            ...
            font-size: 17px;
            font-weight: 400;">
          <b style="margin: 0px; outline: 0px; padding: 0px">Mdm Komathi Kesavan</b>
        </div>
        <div style="margin: 0px;
            outline: 0px;
            padding: 0px;
        ...
        <div style="margin: 0px;
          ...
          Email:<span>&nbsp;</span><a style="margin: 0px;
              ...
              padding: 0px;
              color: rgb(42, 103, 183);
              text-decoration: underline;" target="" href="mailto:komathi_kesavan@schools.gov.sg">komathi_kesavan@schools.gov.sg</a>
        </div>
      </td>
    </tr>
    <tr style="margin: 0px; outline: 0px; padding: 0px">
      ...
      <td style="margin: 0px;
        ...
        <div style="margin: 0px;
            ...
            font-size: 17px;
            font-weight: 400;">
          <b style="margin: 0px; outline: 0px; padding: 0px">Mr Tan Kok Kwang</b>
        </div>
        <div style="margin: 0px;
            outline: 0px;
            padding: 0px;
      ...
      <td style="margin: 0px;
        ...
        <div style="margin: 0px;
            ...
            font-size: 17px;
            font-weight: 400;">
          Designation: Head of Department - English Language and Literature
        </div>
        <div style="margin: 0px;
            outline: 0px;
            padding: 0px;
      ...
      <td style="margin: 0px;
        ...
        <img style="margin: 0px 10px 0px 0px;
            ...
            float: left;
            width: 115px;
            height: 149px;" class="ive_eobj_left" alt="Latifah Bte Abdul Latiff.jpg" src="/images/Humanities/lim_aiwen_bernadine.jpg"><br style="margin: 0px; outline: 0px; padding: 0px">
      </td>
      <td style="margin: 0px;
          outline: 0px;
          padding: 0px 15px 15px 0px;
      ...
      <td style="margin: 0px;
        ...
        <img style="margin: 0px 10px 0px 0px;
            ...
            float: left;
            width: 107px;
            height: 147px;" class="ive_eobj_left" alt="Lim Boon Ping.jpg" src="/images/Science/estella.png"><br style="margin: 0px; outline: 0px; padding: 0px">
      </td>
      <td style="margin: 0px;
          outline: 0px;
          padding: 0px 15px 15px 0px;
    ...
    <tr style="margin: 0px; outline: 0px; padding: 0px">
      ...
      <td style="margin: 0px;
        ...
        <div style="margin: 0px;
            ...
            font-size: 17px;
            font-weight: 400;">
          Designation: Lead Teacher – English Language &amp; Literature
        </div>
        <div style="margin: 0px;
            outline: 0px;
            padding: 0px;
