    ...
    <tr style="box-sizing: inherit;
      ...
      <td style="box-sizing: inherit;
        ...
        <p style="box-sizing: inherit;
            ...
            font-weight: 400;
            text-align: left;">
          Drama (English) Team A - Accomplishment
        </p>
        <p style="box-sizing: inherit;
            font-family: Helvetica, sans-serif;
            margin: 0px 0px 10px;
            ...
            font-weight: 400;
            text-align: left;">
          Drama (English) Team B - Accomplishment
        </p>
        <p style="box-sizing: inherit;
            font-family: Helvetica, sans-serif;
            margin: 0px 0px 10px;
      ...
      <td style="box-sizing: inherit;
        ...
        <p style="box-sizing: inherit;
          ...
          <b style="box-sizing: inherit;
              ...
              margin: 0px;
              outline: 0px;
              padding: 0px;">Sustained Achievement Award for Aesthetics</b>
        </p>
        <p style="box-sizing: inherit;
            font-family: Helvetica, sans-serif;
            margin: 0px 0px 10px;
        ...
        <p style="box-sizing: inherit;
            ...
            font-weight: 400;
            text-align: left;">
          Chinese Dance Team A – Distinction
        </p>
        <p style="box-sizing: inherit;
            font-family: Helvetica, sans-serif;
            margin: 0px 0px 10px;
            ...
            font-weight: 400;
            text-align: left;">
          Chinese Dance Team B - Accomplishment&nbsp;
        </p>
        <p style="box-sizing: inherit;
            font-family: Helvetica, sans-serif;
            margin: 0px 0px 10px;
            ...
            font-weight: 400;
            text-align: left;">
          MLDDS (Malay Dance) - Accomplishment
        </p>
        <p style="box-sizing: inherit;
            font-family: Helvetica, sans-serif;
            margin: 0px 0px 10px;
            ...
            font-weight: 400;
            text-align: left;">
          Drama (English) Team A – Distinction
        </p>
        <p style="box-sizing: inherit;
            font-family: Helvetica, sans-serif;
            margin: 0px 0px 10px;
        ...
        <p style="box-sizing: inherit;
            ...
            font-weight: 400;
            text-align: left;">
          Concert Band Team A – Distinction
        </p>
        <p style="box-sizing: inherit;
            font-family: Helvetica, sans-serif;
            margin: 0px 0px 10px;
            ...
            font-weight: 400;
            text-align: left;">
          Concert Band Team B – Accomplishment
        </p>
      </td>
    </tr>
    <tr style="box-sizing: inherit;
      ...
      <td style="box-sizing: inherit;
        ...
        <p style="box-sizing: inherit;
            ...
            font-weight: 400;
            text-align: left;">
          Heng Chin Soo Award for Visual, Creative &amp; Performing Arts – Nur
          Sophia Zahra Khan
        </p>
      </td>
    </tr>
...
<table style="box-sizing: inherit;
    ...
    outline: 0px;
    padding: 0px;
    border: 1px solid rgb(170, 170, 170);" class="iveo_table ives_tab_simple3">
  <tbody style="box-sizing: inherit;
      font-family: Lato, sans-serif;
      margin: 0px;
      outline: 0px;
    ...
    <tr style="box-sizing: inherit;
      ...
      <td style="box-sizing: inherit;
        ...
        <p style="box-sizing: inherit;
            ...
            font-weight: 400;
            text-align: left;">
          Percussion Ensemble – Distinction
        </p>
        <p style="box-sizing: inherit;
            font-family: Helvetica, sans-serif;
            margin: 0px 0px 10px;
