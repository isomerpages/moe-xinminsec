  ...
  <tbody style="margin: 0px; outline: 0px; padding: 0px">
    <tr style="margin: 0px; outline: 0px; padding: 0px">
      <td style="margin: 0px;
          ...
          padding: 0px 15px 15px 0px;
          vertical-align: top;">
        <img style="width=" class="ive_eobj_center" alt="Math_1.jpg" src="/images/Cce/National_education/ndp staff contingent.jpeg"> 
        <div style="margin: 0px;
          outline: 0px;
          padding: 0px;
          line-height: 24.99px;
      ...
      <td style="margin: 0px;
          ...
          padding: 0px 15px 15px 0px;
          vertical-align: top;">
      <img style="width=" class="ive_eobj_center" alt="Math_2.jpg" width="100%" src="/images/Cce/National_education/ndp sticker designed by students.jpeg">
        <div style="margin: 0px;
          outline: 0px;
          padding: 0px;
          line-height: 24.99px;
  ...
  <tbody style="margin: 0px; outline: 0px; padding: 0px">
    <tr style="margin: 0px; outline: 0px; padding: 0px">
      <td style="margin: 0px;
          ...
          padding: 0px 15px 15px 0px;
          vertical-align: top;">
        <img src="/images/Cce/National_education/racial harmony day staff photo.jpeg" alt="Math_1.jpg" class="ive_eobj_center" style="width="> 
        <div style="margin: 0px;
          outline: 0px;
          padding: 0px;
          line-height: 24.99px;
          ...
          text-align: left;">
        <br>
        Racial Harmony Day Staff Photo
      </div>
      </td>
      <td style="margin: 0px;
          outline: 0px;
          padding: 0px 15px 15px 0px;
          vertical-align: top;">
      <img src="/images/Cce/National_education/racial harmony day student photo booth.jpeg" width="100%" alt="Math_2.jpg" class="ive_eobj_center" style="width=">
        <div style="margin: 0px;
          outline: 0px;
          padding: 0px;
          line-height: 24.99px;
          ...
          text-align: left;">
        <br>
        Racial Harmony Day Student Photo Booth
      </div>
      </td>
    </tr>
  </tbody>
