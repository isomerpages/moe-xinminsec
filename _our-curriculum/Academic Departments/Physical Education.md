  ...
  <tbody style="margin: 0px; outline: 0px; padding: 0px">
    <tr style="margin: 0px; outline: 0px; padding: 0px">
      <td style="margin: 0px;
          ...
          padding: 0px 15px 15px 0px;
          vertical-align: top;">
        <img src="/images/Physical_Education/Department_programmes/physical_education_6c.jpg" alt="Math_1.jpg" class="ive_eobj_center" style="width:">
        <div style="margin: 0px;
            outline: 0px;
            padding: 0px;
            line-height: 24.99px;
  ...
  <tbody style="margin: 0px; outline: 0px; padding: 0px">
    <tr style="margin: 0px; outline: 0px; padding: 0px">
      <td style="margin: 0px;
          ...
          padding: 0px 15px 15px 0px;
          vertical-align: top;">
        <img style="width:" class="ive_eobj_center" alt="Math_1.jpg" src="/images/Physical_Education/Department_programmes/physical_education_5.jpg">
        <div style="margin: 0px;
            outline: 0px;
            padding: 0px;
            line-height: 24.99px;
